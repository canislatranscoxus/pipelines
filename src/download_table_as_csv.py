...
usage
python -m download_table_as_csv --input stg_mty_metro_area  --output ~/data_lake/out/stg_mty_metro_area 
...
def run(argv=None, save_main_session=True):
  ...
  with beam.Pipeline(options=pipeline_options) as p:
    ...
    (
        ...
        | "get data" >> beam.Map( lambda d: '{min_cp}|{max_cp}|{D_mnpio}'.format( **d ) )
